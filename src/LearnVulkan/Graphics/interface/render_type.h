...
namespace gfx
{
    enum class gfx_IMAGE_TYPE : uint8_t
    {
        gfx_IMAGE_TYPE_UNKNOWM = 0,
        gfx_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        gfx_IMAGE_TYPE   m_type { gfx_IMAGE_TYPE::gfx_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<gfx::MeshSourceDesc>
{
    size_t operator()(const gfx::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<gfx::MaterialSourceDesc>
{
    size_t operator()(const gfx::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
